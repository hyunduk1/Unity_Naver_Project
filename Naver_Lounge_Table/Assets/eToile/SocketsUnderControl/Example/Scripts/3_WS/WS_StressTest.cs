...
public class WS_StressTest : MonoBehaviour
{
    public GameObject popupPrefab;
    UnityWSConnection _connection;
    // UI elements:
    Canvas _canvas;
    Dropdown _ddMode;
    InputField _ifSize;
    ...
    void Start ()
    {
        _connection = transform.parent.Find("Panel").GetComponent<UnityWSConnection>();
    ...
    public void OnMessage(byte[] message, UnityWSConnection connection)
    {
    ...
    public void OnClose(UnityWSConnection connection)
    {
        StopTest();
    }
    ...
    public void StartTest()
    {
        ...
        else
        {
            ...
            popup.GetComponent<PopUp>().SetMessage("[WS Stress test] The WS connection is closed.", transform, 10f);
        }
    }
    ...
    {
        GameObject popup = Instantiate(popupPrefab);
        popup.GetComponent<PopUp>().SetMessage("[WS Stress test] " + message, transform, 10f);
    }
}